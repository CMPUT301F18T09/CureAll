        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                if (direction == ItemTouchHelper.UP){
                    ...
                    //TODO we need a local save here. Since we update the record to server.
                    //TODO if you decide to have a local save here, in other activities, make sure the records are save in one file.
                    //TODO such that all pages access same records
