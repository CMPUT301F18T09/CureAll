...
public class PatientListOfProblemsPageActivityTest {
    ...
    @Test
    public void Profile(){
        Espresso.onView(ViewMatchers.withId(R.id.userNameInput)).perform(typeText("connor"), closeSoftKeyboard());
        Espresso.onView(ViewMatchers.withId(R.id.passwordInputpass)).perform(typeText(""), closeSoftKeyboard());
