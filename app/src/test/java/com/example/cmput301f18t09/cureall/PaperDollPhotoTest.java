...
public  class PaperDollPhotoTest {
    @Test

    public void addGeoLocationPhoto(){
    ...
    @Test
    public void getAPointLocation(){
        String aPointLocation = "point";
        GeoLocation geoLocation = new geoLocation("point");
        assertEquals( geoLocation.getLocation, aPointLocation);
    }
