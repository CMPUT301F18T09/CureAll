...
public class MyAdapter extends BaseAdapter {
	...
	private ArrayList<Problems> data;

	public MyAdapter(ArrayList<Problems> data) {                                                   //get the date which is ArrayList<BaseStyle>
		this.data = data;
	}
	...
	public View getView(final int i, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			viewHolder.Dbutton = (Button) view.findViewById(....)
			view.setTag(viewHolder);

		}
		viewHolder = (ViewHolder) view.getTag();

		Problems temp = data.get(i);                                                               //get the context of each list

		String t = ....              //the history
		viewHolder.TextV.setText(t);                                                                //the button
		viewHolder.ESbutton.setText("Edit/View");
		viewHolder.Dbutton.setText("Delete");
	...
	class ViewHolder {                                                                              //the item in layout.xml
		TextView TextV;
		Button ESbutton;				//show the detail of a specific problem
